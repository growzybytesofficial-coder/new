    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* Head */}
          <path d="M 648 60 C 655 48, 668 40, 678 42 C 675 55, 665 68, 655 78 Z" fill="#ffffff" stroke="#94a3b8" strokeWidth="2" />
          ...
          {/* Circuits */}
          <path d="M 280 165 L 385 165 L 405 180 L 450 180" stroke="#ffffff" strokeWidth="4" strokeLinecap="round" />
          <circle cx="452" cy="180" r="6" fill="#ffffff" stroke="#0099ff" strokeWidth="2" />
          <path d="M 260 190 L 330 190 L 350 205 L 485 205" stroke="#ffffff" strokeWidth="4" strokeLinecap="round" />
          <circle cx="488" cy="205" r="6.5" fill="#ffffff" stroke="#0077e6" strokeWidth="2" />
          <path d="M 245 215 L 305 215 L 325 230 L 440 230" stroke="#ffffff" strokeWidth="4" strokeLinecap="round" />
          <circle cx="442" cy="230" r="6" fill="#ffffff" stroke="#0099ff" strokeWidth="2" />
        </svg>
      </div>
    )
  }
      ...
      <div className="relative shrink-0">
        ...
        >
          ...
          >
            ...
            <path d="M 245 275 C 170 300, 65 335, 115 305 C 205 265, 245 252, 245 275 Z" fill="#0066cc" />
            {/* Circuits */}
            <path d="M 280 165 L 385 165 L 405 180 L 450 180" stroke="#ffffff" strokeWidth="5" strokeLinecap="round" />
            <circle cx="452" cy="180" r="7" fill="#ffffff" stroke="#0099ff" strokeWidth="2" />
            <path d="M 260 190 L 330 190 L 350 205 L 485 205" stroke="#ffffff" strokeWidth="5" strokeLinecap="round" />
            <circle cx="488" cy="205" r="7" fill="#ffffff" stroke="#0077e6" strokeWidth="2" />
          </svg>
        </div>
