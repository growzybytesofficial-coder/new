          ...
          <div className="lg:col-span-4 space-y-5">
            <div className="space-y-2">
              <div className="flex items-center gap-2.5">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-red-600 to-red-800 text-white font-black text-lg shadow-md shadow-red-950/40 border border-red-400/20">
                  IT
                </div>
                <div>
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-red-400 block mt-1">
